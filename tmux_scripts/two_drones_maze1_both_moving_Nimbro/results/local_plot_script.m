...
matFileName = 'AgentAvoidanceTest2UAV1.mat'; % [USER INPUT] Data first uav
data = load(matFileName);
%% axisTimeShift
extra_time_offset = 0; % [USER INPUT]
...
matFileName2 = 'AgentAvoidanceTest2UAV3.mat'; % [USER INPUT] Data second uav
data2 = load(matFileName2);
%% axisTimeShift
extra_time_offset = 4.676-5; % [USER INPUT]
[data2, timeAxisStartVal, timeAxisEndVal] = axisTimeShift(data2,extra_time_offset);
...
%% 1) Position 
plot_positions_agent_avoidance(data, data2, plotGraphicsProps)
%% 2) DSM
plot_DSM(data2, plotGraphicsProps,false,false,true)
